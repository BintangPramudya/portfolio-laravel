...
<head>
    ...
    {{-- Pnggil css dinamis per-halaman --}}
    @stack('css')

</head>

<body>
    <header class="navbar navbar-light sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">
            <small class="text-white">Welcome {{ auth()->user()->name }}</small> </a>
