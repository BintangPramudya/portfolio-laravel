...
@section('title', 'Bintang Pramudya | Project 2')
@section('content')
    ...
    <div class="site-wrap">
        ...
        <section class="site-section portfolio-single" id="next-section">
            ...
            <div class="container">
                <div class="row mb-5">
                    <div class="col-md-6">
                        <p>Projek ini saya buat untuk latihan saya terhadap framework laravel.</p>
                    </div>
                </div>
                <div class="row mb-5">
                ...
                <div class="row mb-5 mt-5">
                    ...
                    <div class="col-lg-6">
                        <figure>
                            <a href="#" data-fancybox="gallery"><img src="{{asset('/')}}template/images/project-2.png"
                    ...
                    <div class="col-lg-5 ml-auto h-100 jm-sticky-top">
                        <div class="mb-5">
                            ...
                            <p class="mb-0">Web ini saya buat untuk kelas saya dan sekaligus untuks saya belajar laravel</p>
                        </div>
                    </div>
                </div>
