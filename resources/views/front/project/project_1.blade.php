...
@section('title', 'Bintang Pramudya | Project 1')
@section('content')
    ...
    <div class="site-wrap">
        ...
        <section class="site-section portfolio-single" id="next-section">
            ...
            <div class="container">
                <div class="row mb-5">
                    <div class="col-md-6">
                        <p>Projek ini saya buat untuk latihan saya terhadap bahasa pemrograman php.</p>
                    </div>
                </div>
                <div class="row mb-5">
                    ...
                    <div class="col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-3">
                        ...
                        <a href="https://bintangstar16.000webhostapp.com" target="_blank" class="spepcial_link">Visit Website</a>
                    </div>
                </div>
                <div class="row mb-5 mt-5">
                    ...
                    <div class="col-lg-6">
                        <figure>
                            <a href="#" data-fancybox="gallery"><img src="{{asset('/')}}template/images/project-1.png"
                                    alt="Image" class="img-fluid border"></a>
                        </figure>
                    </div>
                    <div class="col-lg-5 ml-auto h-100 jm-sticky-top">
                        <div class="mb-5">
                            <h3 class="mb-4 h4">CRUD Mahasiswa</h3>

                            <p class="mb-0">Web ini saya buat untuk kelas saya dan sekaligus untuks saya belajar php</p>
                        </div>
                    </div>
                </div>
